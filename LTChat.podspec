#
#  Be sure to run `pod spec lint LTChat.podspec' to ensure this is a
...
Base on XMPP framework and WebRTC framework. First release.
  ...
  # Or just: s.author    = "liangtong"
  # s.authors            = { "liangtong" => "l900416@163.com" }
  s.social_media_url   = "https://l900416.github.io"
